...
<body>
  ...
  <div class="container">
    ...
    <p class="subtitle" id="typewriter" style="font-style: italic; color: #6e6e73; white-space: nowrap; overflow: hidden; border-right: 2px solid #888;"></p>
    <script>
    ...
    <img src="WechatIMG1021.jpg" alt="Soo (Cao Xiru)'s Avatar" class="avatar" />
    <h1 style="font-size: 32px; font-weight: 600; letter-spacing: 1px;">Soo (Cao Xiru)</h1>
